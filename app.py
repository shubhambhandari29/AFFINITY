...
from api.affinity.claim_review_distribution import (
    router as claim_review_distribution_affinity_router,
)
from api.affinity.claim_review_frequency import (
    router as claim_review_frequency_affinity_router,
)
from api.affinity.loss_run_distribution import (
    router as loss_run_distribution_affinity_router,
)
from api.affinity.loss_run_frequency import router as loss_run_frequency_affinity_router
from api.affinity.policy_type_distribution import (
    router as policy_type_distribution_affinity_router,
)
from api.affinity.search_affinity_program import (
    router as search_affinity_program_router,
)
...
app.include_router(
    affinity_policy_types_router, prefix="/affinity_policy_types", tags=["affinity_policy_types"]
)
app.include_router(
    search_affinity_program_router,
    prefix="/search_affinity_program",
    tags=["search_affinity_program"],
)

app.include_router(
    loss_run_distribution_affinity_router,
    prefix="/loss_run_distribution_affinity",
    tags=["loss_run_distribution_affinity"],
)
app.include_router(
    claim_review_distribution_affinity_router,
    prefix="/claim_review_distribution_affinity",
    tags=["claim_review_distribution_affinity"],
)
app.include_router(
    policy_type_distribution_affinity_router,
    prefix="/policy_type_distribution_affinity",
    tags=["policy_type_distribution_affinity"],
)

app.include_router(
    loss_run_frequency_affinity_router,
    prefix="/loss_run_frequency_affinity",
    tags=["loss_run_frequency_affinity"],
)
app.include_router(
    claim_review_frequency_affinity_router,
    prefix="/claim_review_frequency_affinity",
    tags=["claim_review_frequency_affinity"],
)
